          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-wrap gap-3">
              <Button
                ...
                className="h-12 rounded-full bg-linear-to-r from-[#0a4da2] to-[#7c6cff] px-7 text-base font-semibold text-white shadow-[0_18px_45px_-26px_rgba(7,30,84,0.75)] transition hover:-translate-y-0.5 hover:shadow-[0_22px_55px_-30px_rgba(7,30,84,0.6)]"
              >
                Start Contributing
              </Button>
            </div>
